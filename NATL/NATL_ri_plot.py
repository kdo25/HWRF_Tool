## Creates a histogram comparing NATL_ri.py and NATL_climo_ri.py
...
if startYear == endYear:
    ax.set_title('Days ATL Storms Intensified and Rapidly Intensified during %s' %(endYear1))
else:
    ax.set_title('Days ATL Storms Intensified and Rapidly Intensified from %s-%s' %(startYear1, endYear1))
